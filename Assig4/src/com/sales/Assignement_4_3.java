...
public class Assignement_4_3 {
    ...
    Mapper<LongWritable,Text,Text,IntWritable>
    {
		...
		public void map(LongWritable arg0, Text value, OutputCollector<Text, IntWritable> output, Reporter arg3)
			...
			output.collect(new Text(columns[3]), new IntWritable(1));
	...
	public static void main(String[] args) throws Exception{
		// TODO Auto-generated method stub
			...
			JobConf config = new JobConf(Assignement_4_3.class);
			...
			FileOutputFormat.setOutputPath(config,new Path("/output4.2/"));
